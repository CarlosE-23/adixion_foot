            ...
            <div className="w-full h-full flex flex-row items-center relative overflow-hidden justify-end">
                ...
                <div className="relative w-2/10 md:w-6/10 h-1/2 md:h-full">
                    <Image
                        ...
                        width={1500}
                        height={1000}
                        className="block max-w-none absolute top-30 md:top-40 xl:top-15 -right-5 md:right-1/2 xl:-right-40 md:translate-x-4/10 xl:translate-x-0 ease-in-out transition-all duration-600 w-70 md:w-220 h-60 xl:w-[1500] md:h-110 lg:h-[600] xl:h-[700] md:object-contain"
                        style={imageStyle}
                    />
                </div>
            </div>
